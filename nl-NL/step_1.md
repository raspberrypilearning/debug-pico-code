+ Controleer de Shell in Thonny op foutmeldingen.
...
+ Voeg `print` instructies toe om je te helpen begrijpen wat er gebeurt zoals `print('Starting')` of `print('Kleur op groen')`. 
